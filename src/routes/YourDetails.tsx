...
export default function YourDetails() {
  ...
  const primaryBtnStyles =
    "flex mt-0 lg:mt-0 justify-center py-3 px-4 border-2 border-figOrange-700 shadow-sm text-sm font-Montserrat font-bold text-white tracking-widest bg-figOrange-700 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 w-full disabled:bg-gray-300 self-center";
      ...
      <div className="h-full bg-image lg:h-fit bg-figGray-300 flex flex-col justify-start py-5 px-5 md:mt-4 lg:px-8 lg:pb-0 lg:flex-row lg:justify-left">
        ...
        <div className="bg-white lg:mt-16 lg:mb-16 min-h-[500px] lg:min-w-[720px] lg:max-w-[720px] form-content">
          <div className="flex flex-col pt-14 pb-60 px-10 lg:pt-12 lg:pb-12 lg:px-20">
            <p className="pl-2 mb-5 font-CapriSans text-figGray-600 lg:text-xl">
              Step 2 of 5
            </p>
            <h1 className="text-4xl font-extrabold mb-7">Your details</h1>
            <p className="md:inline-block pl-2 mb-8 font-CapriSans text-black tracking-widest lg:ml-0">
